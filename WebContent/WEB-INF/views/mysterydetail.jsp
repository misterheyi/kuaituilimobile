...
<!-- 最终页介绍开始 -->
<div class="Cons"><a href="${ctx}index.html">首页</a> > <a href="${ctx}mystery.html">未解之谜</a> > ${mystery.title}</div>
<div class="end">
	<div class="end_title">${mystery.title}</div>
    <div class="end_num">发布日期：<fmt:formatDate value="${mystery.createTime}" pattern="yyyy/MM/dd"/></div>
    <div class="end_time">文章浏览：${mystery.clickTimes}</div>
    <div class="end_con">
    	<img src="${imgContext}${mystery.logoUrl}">
    	${mystery.htmlText}
    </div>
