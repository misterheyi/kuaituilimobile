...
<!-- 最终页介绍开始 -->
<div class="Cons"><a href="index.html">首页</a> > <a href="consultation.html">百科</a> > <a href="consultation.html">短文啊实打实大师大师的</a></div>
<div class="end">
	<div class="end_title">${baike.title}</div>
    <div class="end_num">发布日期：<fmt:formatDate value="${baike.createTime}" pattern="yyyy/MM/dd"/></div>
    <div class="end_time">文章浏览：${baike.clickTimes}</div>
    <div class="end_con">
    	<img src="${imgContext}${baike.logoUrl}">
    	${baike.htmlText}
    </div>
