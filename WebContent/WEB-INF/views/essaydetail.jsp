...
<!-- 最终页介绍开始 -->
<div class="Cons"><a href="${ctx}index.html">首页</a> > <a href="${ctx}essay.html">推理短文</a> > <a href="${ctx}/essay/detail/${essay.id}.html">${essay.title}</a></div>
<div class="end">
	<div class="end_title">${essay.title}</div>
    <div class="end_num">发布日期：<fmt:formatDate value="${essay.createTime}" pattern="yyyy/MM/dd"/></div>
    <div class="end_time">文章浏览：${essay.clickTimes}</div>
    <div class="end_con">
